---
description: schematize-engineering — cria ou ATUALIZA (sobrescreve) o CLAUDE.md da raiz do repositório com a versão atual da skill; faz backup se houver customização local
---

Sincronize o **`CLAUDE.md` da raiz** deste repositório com a versão **atual** da skill `schematize-engineering`.

1. Localize o `assets/CLAUDE.md` da skill: `.claude/skills/schematize-engineering/assets/CLAUDE.md` (instalação no projeto) ou `~/.claude/skills/schematize-engineering/assets/CLAUDE.md` (global).
