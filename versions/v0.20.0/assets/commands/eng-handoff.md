...
1. Use `${PROJECT_ARCHIVE:-<projeto>/<projeto>_archive/context}` e timestamp `<ts>` = `YYYY-MM-DD-HH-MM-SS`.
...
Regras: armazene SEMPRE em `<projeto>/<projeto>_archive` (§28). Sem segredo/PII nos MDs (§16.1).
