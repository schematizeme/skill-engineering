...
- O grafo tem **dois lugares**, com papéis distintos:
  ...
  - **ESPELHO durável:** `<projeto>/_archive/index/` — cópia versionada no archive (§28), para histórico, review de PR e auditoria. Todo update do local **copia pra cá**.
...
**Espelho no archive (`<projeto>/_archive/index/`)**
- `INDEX_GLOBAL.md`, `INDEX_FUNCTIONS.md` e `MAPA.md` **seguem existindo** no espelho `<projeto>/_archive/index/` — o **`MAPA.md` é o resumo** navegável. São o registro durável para review e auditoria.
