...
quê, alternativa descartada — cruza `overdev.md` §0.1); leia o **código, o `MAPA.md` e o
...
- Grava o **PLANO** em `<projeto>_archive/plan/<data>-<contexto>.md` (§28): objetivo/escopo,
...
- **Pede aprovação** antes de executar (como o `/eng-qa`). Aprovado, executa faseado; **achado
