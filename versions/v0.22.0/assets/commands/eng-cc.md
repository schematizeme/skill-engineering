---
description: Context Compact — gera handoff (context.md + checklist.md) no <projeto>/<projeto>_archive e compacta
...
1. **Pasta e timestamp.** Use `${PROJECT_ARCHIVE:-<projeto>/<projeto>_archive/context}` como
...
`<projeto>/<projeto>_archive` (§28). Não inclua segredo nem PII nos MDs (§16.1).
